...
const UNIT_TEST_SUITES = [
  ...
  {
    name: "Negative level order regression",
    file: path.join(__dirname, "check-negative-level-order.js"),
  },
  {
  ...
  // 锁住 iOS / Android App Icon 资源链路，避免原生壳同步时回退成默认占位图标。
  {
    ...
    file: path.join(__dirname, "check-app-icon-assets.js"),
  },
  {
  ...
  {
    name: "Mobile static template regression",
    file: path.join(__dirname, "check-mobile-static-template.js"),
  },
  {
